import {$objectPatternPropertyIndirect as _$objectPatternPropertyIndirect} from 'foo';
...
_$memberExpressionIndirect;
const objectPatternPropertyIndirect = _$objectPatternPropertyIndirect;
