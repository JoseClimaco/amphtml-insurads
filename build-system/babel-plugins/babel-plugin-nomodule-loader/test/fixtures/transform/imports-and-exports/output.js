(function defineish(defineCallback) {
  ...
  var exec = true
    ? function (_exports) {
        ...
        var name =
          'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/imports-and-exports/input';
  ...
  if (false) {
    ...
    Promise.all(
      [
        0,
        'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/imports-and-exports/foo',
      ].map(function (name) {
        if (true && name === 0) {
          return {};
        }
