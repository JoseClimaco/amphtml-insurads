(function defineish(defineCallback) {
  ...
  var exec = true
    ? function (_exports) {
        ...
        var name =
          'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/export-from/input';
  ...
  if (false) {
    ...
    Promise.all(
      [
        0,
        'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/export-from/abc',
      ].map(function (name) {
        if (true && name === 0) {
          return {};
        }
