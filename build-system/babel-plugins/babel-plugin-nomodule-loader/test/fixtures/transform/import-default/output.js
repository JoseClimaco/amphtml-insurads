(function defineish(defineCallback) {
  ...
  var exec = false
    ? function (_exports) {
        ...
        var name =
          'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/import-default/input';
  ...
  if (false) {
    ...
    'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/import-default/x'
  ) {
    var name =
      'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/import-default/x';
