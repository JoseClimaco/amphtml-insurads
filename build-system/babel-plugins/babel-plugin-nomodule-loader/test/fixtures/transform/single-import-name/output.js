(function defineish(defineCallback) {
  ...
  var exec = false
    ? function (_exports) {
        ...
        var name =
          'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/single-import-name/input';
  ...
  if (false) {
    ...
    'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/single-import-name/foo'
  ) {
    var name =
      'build-system/babel-plugins/babel-plugin-nomodule-loader/test/fixtures/transform/single-import-name/foo';
