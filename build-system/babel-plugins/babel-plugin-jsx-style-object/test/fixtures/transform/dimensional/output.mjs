...
const dimensional = () => (
  <div
    style={'width:100px;' + _jsxStylePropertyString('height', height, true)}
  />
);
...
const nonDimensional = () => (
  <div>
    <div
      style={_jsxStylePropertyString2(
    ...
    <div
      style={_jsxStylePropertyString4('border-image-outset', borderImageOutset)}
    />
    <div style={'border-image-outset:2;'} />
    <div
      style={_jsxStylePropertyString5('border-image-slice', borderImageSlice)}
    />
    <div style={'border-image-slice:8;'} />
    <div
      style={_jsxStylePropertyString6('border-image-width', borderImageWidth)}
    />
    ...
    <div
      style={_jsxStylePropertyString9('box-ordinal-group', boxOrdinalGroup)}
    />
    ...
    <div
      style={_jsxStylePropertyString25('grid-column-span', gridColumnSpan)}
    />
    <div style={'grid-column-span:9;'} />
    <div
      style={_jsxStylePropertyString26('grid-column-start', gridColumnStart)}
    />
    ...
    <div
      style={_jsxStylePropertyString40('stroke-dasharray', strokeDasharray)}
    />
    <div style={'stroke-dasharray:10;'} />
    <div
      style={_jsxStylePropertyString41('stroke-dashoffset', strokeDashoffset)}
    />
    <div style={'stroke-dashoffset:10;'} />
    <div
      style={_jsxStylePropertyString42('stroke-miterlimit', strokeMiterlimit)}
    />
