...
console.log(
  html(['<p data-order-state="new \'thing\'">Impossible to Remove Quotes</p>'])
);
console.log(html(['<p><span>html usage</span> <span>more spans</span></p>']));
console.log(
  html([
    '<p><span>html usage</span> <span>whitespace before entry tag</span></p>',
  ])
);
console.log(
  html([
    '<p><span>html usage</span> <span>whitespace after entry tag</span></p>',
  ])
);
console.log(
  html([
    '<p><span>html usage</span> <span>whitespace before and after entry tag</span></p>',
  ])
);
console.log(
  html(['<p><span>html usage</span> <span>comment before entry tag</span></p>'])
);
console.log(
  html(['<p><span>html usage</span> <span>comment after entry tag</span></p>'])
);
console.log(
  html(['<p><span>html usage</span> <span>with comment sibling</span></p>'])
);
...
console.log(
  htmlFor(element)([
    '<p data-order-state="new \'thing\'">Impossible to Remove Quotes</p>',
  ])
);
console.log(
  htmlFor(element)(['<p><span>html usage</span> <span>more spans</span></p>'])
);
console.log(
  htmlFor(element)([
    '<p><span>html usage</span> <span>whitespace before entry tag</span></p>',
...
console.log(
  htmlFor(element)([
    '<p><span>html usage</span> <span>comment before entry tag</span></p>',
  ])
);
console.log(
  htmlFor(element)([
    '<p><span>html usage</span> <span>comment after entry tag</span></p>',
  ])
);
console.log(
  htmlFor(element)([
    '<p><span>html usage</span> <span>with comment sibling</span></p>',
  ])
);
console.log(
  svg([
    '<svg xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink><rect x=10 y=10 height=100 width=100 /></svg>',
  ])
);
console.log(
  svg([
