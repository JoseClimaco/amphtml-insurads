        ...
        if (data0.prop_c !== undefined) {
          ...
          if (data2 && typeof data2 == 'object' && !Array.isArray(data2)) {
            for (const key0 in data2) {
              if (
                !(key0 === 'prop_x' || key0 === 'prop_y' || key0 === 'prop_z')
              ) {
                const err3 = (
                  instancePath +
                  '/' +
                    ...
                    for (const key1 in data4) {
                      if (!func1.call(_schema, key1)) {
                        const err4 = (
                          ...
                          '/' +
                          i0 +
                          '/prop_c/prop_z/objectWithoutAditionalPropertiesA' +
                          ' ' +
                          'must NOT have additional properties'
                        ).trim();
                    ...
                    for (const key2 in data5) {
                      if (!func1.call(_schema2, key2)) {
                        const err5 = (
                          ...
                          '/' +
                          i0 +
                          '/prop_c/prop_z/objectWithoutAditionalPropertiesB' +
                          ' ' +
                          'must NOT have additional properties'
                        ).trim();
                            ...
                            if (data7.prop_abc !== undefined) {
                              ...
                              if (
                                ...
                                const err6 = (
                                  ...
                                  '/' +
                                  i0 +
                                  '/prop_c/prop_z/objectWithoutAditionalPropertiesB/prop_w/prop_xyz/prop_abc' +
                                  ' ' +
                                  'must be equal to one of the allowed values'
                                ).trim();
...
const validate = (data, schemaName = 'object-enum') =>
