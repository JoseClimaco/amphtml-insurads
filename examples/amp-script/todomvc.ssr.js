...
!(function () {
  ...
  function t(t, n) {
    ...
    for (
      n && n.children && (K.length || K.push(n.children), delete n.children);
      K.length;
      ...
      if ((i = K.pop()) instanceof Array)
        ...
        null != i &&
          i !== !1 &&
          (('number' != typeof i && i !== !0) || (i += ''),
          (l = 'string' == typeof i),
          l && r ? (o[o.length - 1] += i) : (o.push(i), (r = l)));
      ...
      : l(t.nodeName)
        ...
        : i(t.nodeName)
          ? !e._componentConstructor ||
            e._componentConstructor === t.nodeName ||
            d(t)
          : void 0;
  }
  function h(e, t) {
  ...
  function y(e, t, n, o, r) {
    if (
      ...
      'class' === t &&
        o &&
        'object' === (void 0 === o ? 'undefined' : te(o)) &&
        (o = a(o)),
      'key' === t)
    );
    else if ('class' !== t || r)
      if ('style' === t) {
        if (
          ((!o || l(o) || l(n)) && (e.style.cssText = o || ''),
          o && 'object' === (void 0 === o ? 'undefined' : te(o)))
        ) {
          if (!l(n)) for (var s in n) s in o || (e.style[s] = '');
          for (var c in o)
            e.style[c] = 'number' != typeof o[c] || Z[c] ? o[c] : o[c] + 'px';
        }
        ...
        (t = H(t.substring(2))),
          o
            ? u[t] || e.addEventListener(t, b, !!$[t])
            : u[t] && e.removeEventListener(t, b, !!$[t]),
          (u[t] = o);
      } else if ('list' !== t && 'type' !== t && !r && t in e)
        g(e, t, null == o ? '' : o),
          (null != o && o !== !1) || e.removeAttribute(t);
      else {
        var d = r && t.match(/^xlink\:?(.+)/);
        null == o || o === !1
          ? d
            ? e.removeAttributeNS('http://www.w3.org/1999/xlink', H(d[1]))
            : e.removeAttribute(t)
          : 'object' === (void 0 === o ? 'undefined' : te(o)) ||
            i(o) ||
            (d
              ? e.setAttributeNS('http://www.w3.org/1999/xlink', H(d[1]), o)
              : e.setAttribute(t, o));
      }
    else e.className = o || '';
  }
    ...
    if ((null == t && (t = ''), l(t)))
      return (
        e && e instanceof Text
          ...
          : (e && k(e), (e = document.createTextNode(t))),
        (e[Y] = !0),
        e
      );
        ...
        (y = S(y, m, n, o)),
          y &&
            ...
            (w >= c
              ? e.appendChild(y)
              : y !== r[w] &&
                (y === r[w + 1] && v(r[w]), e.insertBefore(y, r[w] || null)));
      }
    if (a) for (var N in l) l[N] && k(l[N]);
    for (; s <= u; ) (y = i[u--]), y && k(y);
  }
  function k(e, t) {
    var n = e._component;
  ...
  function T(e, t, n) {
    for (var o in n)
      (t && o in t) || null == n[o] || y(e, o, n[o], (n[o] = void 0), ce);
    if (t)
      for (var r in t)
        'children' === r ||
          'innerHTML' === r ||
  ...
  function E(e, t, n, o, r) {
    e._disable ||
      ...
      (e._disable = !1),
      n !== G &&
        (n !== J && z.syncComponentUpdates === !1 && e.base
          ? c(e)
          : O(e, J, r)),
      e.__ref && e.__ref(e));
  }
    ...
    if (!e._disable) {
      ...
      if (
        (g &&
          ...
          e.shouldComponentUpdate(c, u, p) === !1
            ? (a = !0)
        ...
        for (
          e.render && (s = e.render(c, u, p)),
            e.getChildContext && (p = n(o(p), e.getChildContext()));
          d(s);
        ...
        if (i(T)) {
          var B = m(s);
          (S = C),
            S && S.constructor === T && B.key == S.__key
              ? E(S, B, J, p)
              : ((D = S),
                (S = U(T, B, p)),
          ...
          (N = _),
            (D = C),
            D && (N = e._component = null),
            (_ || t === J) &&
              (N && (N._component = null),
              (A = x(N, s, p, r || !g, _ && _.parentNode, !0)));
        if (_ && A !== _ && S !== C) {
          var j = _.parentNode;
          j &&
            A !== j &&
            (j.replaceChild(A, _), D || ((_._component = null), k(_)));
        }
      ...
      !g || r
        ? ae.unshift(e)
        : a ||
          (e.componentDidUpdate && e.componentDidUpdate(h, v, y),
  ...
  function A(e, t, n, o) {
    for (
      var r = e && e._component,
        i = e,
        l = r && e._componentConstructor === t.nodeName,
        a = l,
        s = m(t);
      r && !a && (r = r._parentComponent);

    )
      a = r.constructor === t.nodeName;
    return (
      r && a && (!o || r._component)
        ? (E(r, s, Q, n, o), (e = r.base))
        : (r && !l && (P(r, !0), (e = i = null)),
          (r = U(t.nodeName, s, n)),
          e && !r.nextBase && ((r.nextBase = e), (i = null)),
          E(r, s, J, n, o),
          (e = r.base),
          i && e !== i && ((i._component = null), k(i))),
      e
    );
  }
  function P(e, t) {
  ...
  var z = {},
    ...
    X = {},
    Y =
      'undefined' != typeof Symbol ? Symbol.for('preactattr') : '__preactattr_',
    Z = {
      boxFlex: 1,
      boxFlexGroup: 1,
      columnCount: 1,
    ...
    $ = {blur: 1, error: 1, focus: 1, load: 1, resize: 1, scroll: 1},
    ee = [],
    te =
  ...
  var fe = (function () {
      ...
      return (
        (e.prototype.inform = function () {
          L(this.key, this.todos),
            this.onChanges.forEach(function (e) {
              return e();
            });
        }),
        (e.prototype.addTodo = function (e) {
          (this.todos = this.todos.concat({id: M(), title: e, completed: !1})),
            this.inform();
        }),
        (e.prototype.toggleAll = function (e) {
          (this.todos = this.todos.map(function (t) {
            return ne({}, t, {completed: e});
          })),
            this.inform();
        }),
        (e.prototype.toggle = function (e) {
          (this.todos = this.todos.map(function (t) {
            return t !== e ? t : ne({}, t, {completed: !t.completed});
          })),
            this.inform();
        }),
          ...
          return t(
            ...
            t(
              ...
              t(
                'li',
                null,
                t('a', {href: '#/', class: 'all' == n && 'selected'}, 'All')
              ),
              ' ',
              t(
                'li',
                ...
                t(
                  'a',
                  {href: '#/active', class: 'active' == n && 'selected'},
                  'Active'
                )
              ),
              ' ',
              t(
                ...
                t(
                  'a',
                  {href: '#/completed', class: 'completed' == n && 'selected'},
                  'Completed'
                )
              )
            ),
            r > 0 &&
              t(
                'button',
                {class: 'clear-completed', onClick: i},
                'Clear completed'
              )
          );
        }),
    ...
    ve = (function (e) {
      function n() {
        for (var t, n, o, r = arguments.length, i = Array(r), l = 0; l < r; l++)
          i[l] = arguments[l];
        return (
          (t = n = ie(this, e.call.apply(e, [this].concat(i)))),
          (n.handleSubmit = function () {
            ...
            i ? (t(r, i), n.setState({editText: i})) : o(r);
          }),
          (n.handleEdit = function () {
            var e = n.props,
              t = e.onEdit,
              o = e.todo;
            t(o), n.setState({editText: o.title});
          }),
          (n.toggle = function (e) {
            var t = n.props;
          ...
          (n.handleKeyDown = function (e) {
            if (e.which === he) {
              var t = n.props.todo;
              n.setState({editText: t.title}), n.props.onCancel(t);
      ...
      (function (e) {
        ...
        return (
          ...
          (n.prototype.handleRoute = function () {
            ...
            ye[e] || (e = 'all'), this.setState({nowShowing: e});
          }),
          (n.prototype.render = function (e, n) {
            var o = this,
              r = n.nowShowing,
