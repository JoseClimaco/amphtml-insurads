...
})()(
  {
    1: [
      function (require, module, exports) {
        'use strict';
        var _inputmask = require('./inputmask.dependencyLib'),
          _inputmask2 = require('./inputmask'),
          _inputmaskDate = require('./inputmask.date.extensions');
        function factory(e) {
          var n = e.ownerDocument,
            t = n.defaultView,
            i = (0, _inputmask.factory)(t, n),
            a = (0, _inputmask2.factory)(i, t, n, void 0);
          return (0, _inputmaskDate.factory)(a), a;
        }
        (window.AMP = window.AMP || []).push(function (e) {
          (e.dependencies = e.dependencies || {}).inputmaskFactory = factory;
        });
      },
      {
        './inputmask': 4,
        './inputmask.date.extensions': 2,
        './inputmask.dependencyLib': 3,
      },
    ],
    2: [
      function (require, module, exports) {
        ...
        function factory(e) {
          ...
          function a(e) {
            if (!e.tokenizer) {
              var t = [];
              for (var o in r) -1 === t.indexOf(o[0]) && t.push(o[0]);
              (e.tokenizer = '(' + t.join('+|') + ')+?|.'),
          ...
          function n(t, o, n, i) {
            for (var s, u = ''; (s = a(n).exec(t)); ) {
              if (void 0 === o)
                ...
                if (!0 !== i && r[s[0]][3]) u += r[s[0]][3].call(o.date);
                else r[s[0]][2] ? (u += o['raw' + r[s[0]][2]]) : (u += s[0]);
              else u += s[0];
            }
            return u;
          }
          ...
          function s(e, t, o) {
            ...
            function p(e) {
              ...
              if (t != e) {
                var r = e.replace(/[^0-9]/g, ''),
                  a = ((o.min && o.min[n]) || e).toString(),
                  i = ((o.max && o.max[n]) || e).toString();
                t =
                  r +
            ...
            function y(e, t, r) {
              (e[n] = p(t)),
                (e['raw' + n] = t),
                void 0 !== s &&
                  s.call(e.date, 'month' == n ? parseInt(e[n]) - 1 : e[n]);
            }
            if ('string' == typeof l) {
              for (; (i = a(o).exec(t)); ) {
                var c = l.slice(0, i[0].length);
                r.hasOwnProperty(i[0]) &&
                  (r[i[0]][0], (n = r[i[0]][2]), (s = r[i[0]][1]), y(u, c)),
                  (l = l.slice(c.length));
              }
              return u;
            }
            if (l && 'object' === _typeof(l) && l.hasOwnProperty('date'))
              return l;
          }
          function u(e) {
            var t = e.inputmask;
            e.inputmask.remove(),
              e.addEventListener('input', function r() {
                0 == e.value.length &&
                  (e.removeEventListener('input', r), t.mask(e));
              });
          }
          return (
            e.extendAliases({
              datetime: {
                ...
                postValidation: function (e, t, r, o, a) {
                  (o.min = s(o.min, o.inputFormat, o)),
                    (o.max = s(o.max, o.inputFormat, o));
                  var i = r,
                    u = s(e.join(''), o.inputFormat, o);
                  if (i && u.date.getTime() == u.date.getTime()) {
                    var l =
                      (i = (function (e, t) {
                        return (
                          (!isFinite(e.rawday) ||
                      ...
                      (function (e, t) {
                        var r = !0;
                        if (!e.rawyear || !e.rawmonth || !e.rawday) return !1;
                        if (t.min) {
                          if (e.rawyear) {
                            var o = e.rawyear.replace(/[^0-9]/g, '');
                            r = t.min.year.substr(0, o.length) <= o;
                          }
                          e.year === e.rawyear &&
                            t.min.date.getTime() == t.min.date.getTime() &&
                            (r = t.min.date.getTime() <= e.date.getTime());
                        }
                        return (
                          r &&
                            t.max &&
                            t.max.date.getTime() == t.max.date.getTime() &&
                            (r = t.max.date.getTime() >= e.date.getTime()),
                          r
                        );
                      })(u, o);
                    if (t && l && r.pos !== t)
                      return {
                        buffer: n(o.inputFormat, u, o),
                  ...
                  if (1 === c.length) {
                    ...
                    return {
                      buffer: e.concat([d]),
                      refreshFromBuffer: {start: t, end: e.length + 1},
                    };
                  }
                  return i;
                },
                onKeyDown: function (r, o, n, s, l, p) {
                  var y = this;
                  if (r.ctrlKey && r.keyCode === e.keyCode.RIGHT) {
                    for (
                      var c, d = new Date(), m = '';
                      (c = a(s).exec(s.inputFormat));

                    )
                      'd' === c[0].charAt(0)
                        ? (m += i(d.getDate(), c[0].length))
                        : 'm' === c[0].charAt(0)
                          ? (m += i(d.getMonth() + 1, c[0].length))
                          : 'yyyy' === c[0]
                            ? (m += d.getFullYear().toString())
                            : 'y' === c[0].charAt(0) &&
                              (m += i(d.getYear(), c[0].length));
                    y.inputmask._valueSet(m), t(y).trigger('setvalue');
                  }
                  var f = p.begin,
                    h = p.end;
                  if (
                    r.keyCode === e.keyCode.BACKSPACE ||
                    r.keyCode === e.keyCode.DELETE ||
                    ((r.metaKey || r.ctrlKey) &&
                      r.keyCode === 'X'.charCodeAt(0))
                  ) {
                    var g = y.value.length,
                      D = y.selectionStart != g && y.selectionEnd != g;
                    if (g > 0 && D) {
                      u(y);
                      var v = h - f;
                      if (r.keyCode === e.keyCode.BACKSPACE) {
                        var F = 0 == v ? f - 1 : f;
                        (y.value = l.slice(0, F) + l.slice(h)),
                          y.setSelectionRange(F, F);
                      } else if (r.keyCode === e.keyCode.DELETE) {
                        var M = 0 == v ? h + 1 : h;
                        (y.value = l.slice(0, f) + l.slice(M)),
                          y.setSelectionRange(f, f);
                      }
                    }
                    ...
                    if (
                      (r.metaKey || r.ctrlKey) &&
                      r.keyCode === 'V'.charCodeAt(0)
                    )
                      return void u(y);
                    if (r.metaKey || r.ctrlKey) return;
                    var S = String.fromCharCode(r.keyCode),
                      T = r.shiftKey
                        ? S.toLocaleUpperCase()
                        : S.toLocaleLowerCase();
                    /\s/.test(T) ||
                      (u(y),
                      setTimeout(function () {
                        (y.value = l.slice(0, f) + T + l.slice(h)),
                          y.setSelectionRange(f + 1, f + 1);
                      }, 0));
                  }
                },
                onUnMask: function (e, t, r) {
                  return n(r.outputFormat, s(e, r.inputFormat, r), r, !0);
                },
                casing: function (e, t, r, o) {
          ...
          return (
                ...
                if (o(this[0]))
                  for (
                    var n = function (e, t, n) {
                        if ((e in r) == !0)
                          if (
                            ...
                            for (var o in r[e])
                              r[e][o].splice(r[e][o].indexOf(n), 1);
                          else r[e][t].splice(r[e][t].indexOf(n), 1);
                      },
                      i = function (e, n) {
                        var o,
                          i,
                        ...
                        if (e.length > 0)
                          ...
                          for (var l in r)
                            for (var f in r[l])
                              if (f === n)
                                if (void 0 === t)
                                  for (o = 0, i = r[l][f].length; o < i; o++)
                                    a.push({
                                      ev: l,
                                      namespace: f,
                                      handler: r[l][f][o],
                                    });
                                else a.push({ev: l, namespace: f, handler: t});
                        return a;
                      },
                      r = this[0].eventRegistry,
                      a = this[0],
                      l = e.split(' '),
                      f = 0;
                    f < l.length;
                    ...
                    for (
                      ...
                      n(c[u].ev, c[u].namespace, c[u].handler);
                return this;
              },
              trigger: function (e) {
                if (o(this[0]))
                  for (
                    ...
                    if (void 0 !== t && 'global' === c) {
                      ...
                      if (t.createEvent) {
                        try {
                          u =
                            ['change', 'input', 'click'].indexOf(s) > -1
                              ? new Event(s, p)
                              : new CustomEvent(s, p);
                        } catch (e) {
                          (u = t.createEvent('CustomEvent')).initCustomEvent(
                            s,
                            p.bubbles,
                            p.cancelable,
                            p.detail
                        ...
                        e.type && i.extend(u, e), r.dispatchEvent(u);
                      } else
                        ((u = t.createEventObject()).eventType = s),
                          (u.detail = arguments[1]),
                          e.type && i.extend(u, e),
                          r.fireEvent('on' + u.eventType, u);
                    } else if (void 0 !== n[s])
                      if (
                        ...
                        for (var y in n[s])
                          for (v = 0; v < n[s][y].length; v++)
                            n[s][y][v].apply(r, arguments);
                      else
                        for (v = 0; v < n[s][c].length; v++)
                          n[s][c][v].apply(r, arguments);
                  }
                return this;
              },
            }),
            ...
            (i.extend = function () {
              ...
              for (
                'boolean' == typeof l &&
                  ((c = l), (l = arguments[f] || {}), f++),
                  'object' === _typeof(l) || i.isFunction(l) || (l = {}),
                  f === s && ((l = this), f--);
                f < s;
                f++
              )
                if (null != (e = arguments[f]))
                  for (t in e)
                    (n = l[t]),
                      l !== (o = e[t]) &&
                        (c && o && (i.isPlainObject(o) || (r = i.isArray(o)))
                          ? (r
                              ? ((r = !1), (a = n && i.isArray(n) ? n : []))
      ...
      function (require, module, exports) {
        ...
        function factory(e, t, n, i) {
          ...
          function f(t, n) {
            ...
            if (
              (e.isFunction(t.mask) && (t.mask = t.mask(t)), e.isArray(t.mask))
            ) {
              if (t.mask.length > 1) {
          ...
          function h(a, u, f) {
            ...
            function A(e, t, n, a, r) {
              ...
              S();
              do {
                if (!0 === e && w().validPositions[p])
                  (l = (c =
                    r &&
                    !0 === w().validPositions[p].match.optionality &&
                    w().validPositions[p + 1] === i &&
                    (!0 === w().validPositions[p].generatedInput ||
                      (w().validPositions[p].input ==
                        f.skipOptionalPartCharacter &&
                        p > 0))
                      ? D(p, I(p, s, p - 1))
                      : w().validPositions[p]).match),
                    (s = c.locator.slice()),
                    u.push(
                      !0 === n ? c.input : !1 === n ? l.nativeDef : X(p, l)
                    );
                else {
                  (l = (c = G(p, s, p - 1)).match), (s = c.locator.slice());
                  var h =
                    !0 !== a && (!1 !== f.jitMasking ? f.jitMasking : l.jit);
                  (!1 === h ||
                    h === i ||
                    ('number' == typeof h && isFinite(h) && h > p)) &&
                    u.push(!1 === n ? l.nativeDef : X(p, l));
                }
                'auto' === f.keepStatic &&
                  l.newBlockMarker &&
                  null !== l.fn &&
                ...
                ((v === i || p < v) && (null !== l.fn || '' !== l.def)) ||
                t > p
              );
              return (
                '' === u[u.length - 1] && u.pop(),
                (!1 === n && w().maskLength !== i) || (w().maskLength = p - 1),
                (f.greedy = o),
                u
              );
            }
            ...
            function M(e, t) {
              var n = (e.alternation != i ? e.mloc[j(e)] : e.locator).join('');
              if ('' !== n) for (; n.length < t; ) n += '0';
              return n;
            }
            function D(e, t) {
              for (
                var n, a, r, o = M(T((e = e > 0 ? e - 1 : 0))), s = 0;
                s < t.length;
                s++
              ) {
                var l = t[s];
            ...
            function G(e, t, n) {
              return w().validPositions[e] || D(e, I(e, t ? t.slice() : t, n));
            }
            function T(e, t) {
              return w().validPositions[e]
                ? w().validPositions[e]
                : (t || I(e))[0];
            }
            function B(e, t) {
              for (var n = !1, i = I(e), a = 0; a < i.length; a++)
            ...
            function I(t, n, a) {
              ...
              function h(n, a, o, l) {
                function m(o, l, d) {
                      ...
                      i ||
                        e.each(n.matches, function (e, a) {
                          if (
                            (!0 === a.isQuantifier
                              ? (i = v(t, n.matches[e - 1]))
                              : a.hasOwnProperty('matches') && (i = v(t, a)),
                            i)
                          )
                            return !1;
                        }),
                  ...
                  function g(e, t) {
                    ...
                    return f.regex && null !== e.match.fn && null !== t.match.fn
                      ? -1 !==
                  ...
                  if (s === t && o.matches === i)
                    return (
                      c.push({match: o, locator: l.reverse(), cd: p, mloc: {}}),
                      !0
                    );
                  if (o.matches !== i) {
                    if (o.isGroup && d !== o) {
                      if ((o = m(n.matches[e.inArray(o, n.matches) + 1], l, d)))
                        return !0;
                      ...
                      if (-1 === A || 'string' == typeof A) {
                        ...
                        if ('string' == typeof A) M = A.split(',');
                          ...
                          for (O = 0; O < E.matches.length; O++)
                            M.push(O.toString());
                        if (w().excludes[t]) {
                          for (
                            var D = M.slice(),
                              G = 0,
                              T = w().excludes[t].length;
                            G < T;
                            G++
                          )
                            M.splice(
                              M.indexOf(w().excludes[t][G].toString()),
                              1
                            );
                          0 === M.length && ((w().excludes[t] = i), (M = D));
                        }
                        (!0 === f.keepStatic ||
                          (isFinite(parseInt(f.keepStatic)) &&
                            S >= f.keepStatic)) &&
                          (M = M.slice(0, 1));
                        for (var B = !1, I = 0; I < M.length; I++) {
                          (O = parseInt(M[I])),
                            (c = []),
                            (a =
                              ('string' == typeof A && k(s, O, _)) ||
                              j.slice()),
                            E.matches[O] && m(E.matches[O], [O].concat(l), d)
                              ? (o = !0)
                              : 0 === I && (B = !0),
                            (P = c.slice()),
                            (s = S),
                                  ...
                                  !(
                                    !(
                                      (Q = F).locator
                                        .slice(Q.alternation)
                                        .join('') ==
                                      q.locator.slice(q.alternation).join('')
                                    ) ||
                                    null !== Q.match.fn ||
                                    null === q.match.fn
                                  ) &&
                        ...
                        o = m(E.matches[A] || n.matches[A], [A].concat(l), d);
                      if (o) return !0;
                    } else if (
                      o.isQuantifier &&
                      d !== n.matches[e.inArray(o, n.matches) - 1]
                    )
                      for (
                        var V = o, H = a.length > 0 ? a.shift() : 0;
                        H <
                          (isNaN(V.quantifier.max)
                            ? H + 1
                            : V.quantifier.max) && s <= t;
                        H++
                      ) {
                        ...
                        if ((o = m(U, [H].concat(l), U))) {
                          if (
                            (((r = c[c.length - 1].match).optionalQuantifier =
                              H >= V.quantifier.min),
                            (r.jit =
                              (H || 1) * U.matches.indexOf(r) >=
                              V.quantifier.jit),
                            r.optionalQuantifier && v(r, U))
                          ) {
                            (u = !0), (s = t);
                            break;
                          }
                          return (
                            r.jit && (w().jitOffset[t] = U.matches.indexOf(r)),
                            !0
                          );
                        }
                      }
                ...
                for (
                  var d = a.length > 0 ? a.shift() : 0;
                  d < n.matches.length;
                  d++
                )
                  if (!0 !== n.matches[d].isQuantifier) {
                    var v = m(n.matches[d], [d].concat(o), l);
                    if (v && s === t) return v;
                    if (s > t) break;
                  }
              }
              if (t > -1) {
                if (n === i) {
                  for (
                    var m, d = t - 1;
                    (m = w().validPositions[d] || w().tests[d]) === i && d > -1;
                    ...
                    ((l = (function (t, n) {
                      ...
                      return (
                        ...
                        n.length > 0 &&
                          (n[0].alternation === i
                            ? 0 ===
                                (a = D(t, n.slice()).locator.slice()).length &&
                              (a = n[0].locator.slice())
              ...
              return (
                ...
                n !== i && w().tests[t]
                  ? e.extend(!0, [], c)
                  : ((w().tests[t] = e.extend(!0, [], c)), w().tests[t])
              );
            }
            function L() {
              return (
                w()._buffer === i &&
                  ((w()._buffer = A(!1, 1)),
                  w().buffer === i && (w().buffer = w()._buffer.slice())),
                w()._buffer
              );
            }
            function F(e) {
              return (
                (w().buffer !== i && !0 !== e) ||
                  ((w().buffer = A(!0, S(), !0)),
                  w()._buffer === i && (w()._buffer = w().buffer.slice())),
                w().buffer
              );
            }
            function N(e, t, n) {
              ...
              else for (a = e; a < t; a++) delete w().validPositions[a];
              for (r = e, a = e; a < t; a++)
                if ((O(!0), n[a] !== f.skipOptionalPartCharacter)) {
                  var o = H(r, n[a], !0, !0);
                  !1 !== o &&
                    (O(!0), (r = o.caret !== i ? o.caret : o.pos + 1));
                }
            }
            function R(t, n, i) {
              switch (f.casing || n.casing) {
                ...
                case 'title':
                  ...
                  t =
                    0 === i ||
                    (a && a.input === String.fromCharCode(c.keyCode.SPACE))
                      ? t.toUpperCase()
                      : t.toLowerCase();
                  break;
                default:
            ...
            function V(t, n, a, r, o) {
              var s,
                ...
                p,
                h,
                m = e.extend(!0, {}, w().validPositions),
                d = !1,
                v = o !== i ? o : S();
              if (-1 === v && o === i) l = (u = T((s = 0))).alternation;
              else
                for (; v >= 0; v--)
                  if ((c = w().validPositions[v]) && c.alternation !== i) {
                    if (
                      u &&
              ...
              if (l !== i) {
                (h = parseInt(s)),
                  (w().excludes[h] = w().excludes[h] || []),
                  !0 !== t && w().excludes[h].push(j(u));
                var k = [],
                  g = 0;
                for (f = h; f < S(i, !0) + 1; f++)
                  (p = w().validPositions[f]) && !0 !== p.generatedInput
                    ? k.push(p.input)
                    : f < t && g++,
                    delete w().validPositions[f];
                for (; w().excludes[h] && w().excludes[h].length < 10; ) {
                  var b = -1 * g,
                    y = k.slice();
                  for (w().tests[h] = i, O(!0), d = !0; y.length > 0; ) {
                    var P = y.shift();
                    if (!(d = H(S(i, !0) + 1, P, !1, r, !0))) break;
                  }
                  if (d && n !== i) {
                    var E = S(t) + 1;
                    for (f = h; f < S() + 1; f++)
                      ((p = w().validPositions[f]) === i ||
                        null == p.match.fn) &&
                        f < t + b &&
                        b++;
                    d = H((t += b) > E ? E : t, n, a, r, !0);
                  }
                  if (d) break;
                  if (
                    (O(),
                    (u = T(h)),
                    (w().validPositions = e.extend(!0, {}, m)),
                    !w().excludes[h])
                  ) {
                    d = V(t, n, a, r, h - 1);
                    break;
                  ...
                  for (w().excludes[h].push(C), f = h; f < S(i, !0) + 1; f++)
                    delete w().validPositions[f];
                }
              }
              return (w().excludes[h] = i), d;
            }
            function H(t, n, a, r, o, s) {
                  ...
                  e.each(I(n), function (c, u) {
                    ...
                    if (
                      ...
                      !1 !==
                        (s =
                          null != p.fn
                            ? p.fn.test(a, w(), n, o, f, l(t))
                            : (a === p.def ||
                                a === f.skipOptionalPartCharacter) &&
                              '' !== p.def && {
                                c: X(n, p, !0) || p.def,
                                pos: n,
                              }))
                      ...
                      return (
                        (h =
                          h === f.skipOptionalPartCharacter && null === p.fn
                            ? X(n, p, !0) || p.def
                            : h),
                        s.remove !== i &&
                        ...
                        !0 !== s && s.pos === i && s.c === i
                          ? !1
                          : (Q(t, e.extend({}, u, {input: R(h, p, m)}), r, m) ||
                              (s = !1),
                            !1)
                      );
                    }
              ...
              if (
                (e.isFunction(f.preValidation) &&
                  ...
                  !0 !== r &&
                  !0 !== s &&
                  (p = f.preValidation(F(), c, n, l(t), f, w())),
                !0 === p)
              ) {
                if (
                  (U(i, c, !0),
                  ...
                  if (
                    !m ||
                    null !== m.match.fn ||
                    (m.match.def !== n && n !== f.skipOptionalPartCharacter)
                  ) {
                    if (
                      (f.insertMode || w().validPositions[W(c)] === i) &&
                      (!q(c, !0) || w().jitOffset[c])
                    )
                      if (w().jitOffset[c] && w().validPositions[W(c)] === i)
                        !1 !== (p = H(c + w().jitOffset[c], n, a)) &&
                          (p.caret = c);
                      else
                        for (var d = c + 1, k = W(c); d <= k; d++)
                          if (!1 !== (p = u(d, n, a))) {
                            (p = U(c, p.pos !== i ? p.pos : d) || p), (c = d);
                            break;
                          }
                  } else p = {caret: W(c)};
                }
              ...
              if (
                ...
                var g = f.postValidation(
                  F(!0),
                  t.begin !== i ? (P ? t.end : t.begin) : t,
                  p,
                  f,
                  w()
                );
              ...
              return (
                p && p.pos === i && (p.pos = c),
                (!1 !== p && !0 !== s) ||
                  (O(!0), (w().validPositions = e.extend(!0, {}, h))),
                p
              );
            }
            function U(t, n, a) {
              var r;
              if (t === i)
                for (t = n - 1; t > 0 && !w().validPositions[t]; t--);
              for (var o = t; o < n; o++) {
                if (w().validPositions[o] === i && !q(o, !0))
                  if (0 == o ? T(o) : w().validPositions[o - 1]) {
                    ...
                    if (
                      ...
                      (w().validPositions[n] = i), (r = H(n, c, !0, !0));
                    }
                  }
              }
              return r;
            ...
            function Q(t, n, a, r) {
              function o(e, t, n) {
                ...
                if (
                  a !== i &&
                  ((null === a.match.fn && !0 !== a.match.optionality) ||
                    a.input === f.radixPoint)
                ) {
                  var r =
                      n.begin <= e - 1
              ...
              if (
                ...
                (r = r !== i ? r : s),
                s !== l ||
                  (f.insertMode && w().validPositions[r] !== i && a === i))
              ) {
                var c = e.extend(!0, {}, w().validPositions),
                  u = S(i, !0);
                for (w().p = s, v = u; v >= s; v--)
                  w().validPositions[v] &&
                    '+' === w().validPositions[v].match.nativeDef &&
                    (f.isNegative = !1),
                    delete w().validPositions[v];
                var p = !0,
                  h = r,
                ...
                for (
                  n &&
                  ((w().validPositions[r] = e.extend(!0, {}, n)),
                  d++,
                  h++,
                  s < l && v++);
                  v <= u;
                  ...
                  if (
                    ...
                    for (; '' !== T(d).match.def; ) {
                      if (
                        !1 === m &&
                        c[d] &&
                        c[d].match.nativeDef === k.match.nativeDef
                      )
                        (w().validPositions[d] = e.extend(!0, {}, c[d])),
                          (w().validPositions[d].input = k.input),
                          U(i, d, !0),
                          (h = d + 1),
                          (p = !0);
                        ...
                        (p = !1 !== g),
                          (h = g.caret || g.insert ? S() : d + 1),
                          (m = !0);
                      } else
                        p =
                          !0 === k.generatedInput ||
                          (k.input === f.radixPoint && !0 === f.numericInput);
                      if (p) break;
                      if (
                        !p &&
                        d > l &&
                        q(d, !0) &&
                        (null !== k.match.fn || d > w().maskLength)
                      )
                        break;
                      d++;
                    }
                ...
                if (!p)
                  return (w().validPositions = e.extend(!0, {}, c)), O(!0), !1;
            ...
            function q(e, t) {
              ...
              if (!0 !== t && e > -1) {
                var i = I(e);
                return (
                  i.length > 1 + ('' === i[i.length - 1].match.def ? 1 : 0)
                );
              }
              return !1;
            }
            function W(e, t) {
              for (
                var n = e + 1;
                '' !== T(n).match.def &&
                ((!0 === t && (!0 !== T(n).match.newBlockMarker || !q(n))) ||
                  (!0 !== t && !q(n)));
            ...
            function $(e, t) {
              ...
              for (
                ;
                --i > 0 &&
                ((!0 === t && !0 !== T(i).match.newBlockMarker) ||
                  (!0 !== t &&
                    !q(i) &&
                    ((n = I(i)).length < 2 ||
            ...
            function z(t, n, a, r, o) {
              if (r && e.isFunction(f.onBeforeWrite)) {
                var s = f.onBeforeWrite.call(b, r, n, a, f);
                if (s) {
                  if (s.refreshFromBuffer) {
                    var l = s.refreshFromBuffer;
                    N(!0 === l ? l : l.start, l.end, s.buffer || n),
                      (n = F(!0));
                  }
                    ...
                    for (var l = 0; l < o.length; l++)
                      if (
                        ...
                        (null === o[l].match.fn ||
                          r === i ||
                          !1 !==
                            o[l].match.fn.test(r.match.def, w(), t, !0, f)) &&
                        (s.push(o[l]),
                  ...
                  var r = function (t) {
                    ...
                    if (n.inputmask === i && 'FORM' !== this.nodeName) {
                      ...
                      if (
                        ...
                        return (
                          !1 === p && (t.preventDefault(), t.stopPropagation()),
                          p
                        );
                      }
                      t.preventDefault();
              ...
              ee = {
                keydownEvent: function (t) {
                  var n = e(this),
                    i = t.keyCode,
                    a = ie(this),
                    r = {begin: this.selectionStart, end: this.selectionEnd},
                    o = this.value;
                  if (
                    i === c.keyCode.BACKSPACE ||
                    i === c.keyCode.DELETE ||
                    (l && i === c.keyCode.BACKSPACE_SAFARI) ||
                    ((t.ctrlKey || t.metaKey) && i === c.keyCode.X && !p('cut'))
                  )
                    t.preventDefault(),
                      (t.metaKey || t.ctrlKey) && (a.begin = 0),
                      se(this, i, a),
                      a.end - a.begin == this.value.length && O(!1),
                      z(
                        this,
                        F(!0),
                        w().p,
                    ...
                    t.preventDefault();
                    var s = W(S());
                    ie(this, t.shiftKey ? a.begin : s, s, !0);
                  } else
                    (i === c.keyCode.HOME && !t.shiftKey) ||
                    i === c.keyCode.PAGE_UP
                      ? (t.preventDefault(),
                        ie(this, 0, t.shiftKey ? a.begin : 0, !0))
                      : ((f.undoOnEscape && i === c.keyCode.ESCAPE) ||
                            (90 === i && t.ctrlKey)) &&
                          !0 !== t.altKey
                        ? (te(this, !0, !1, m.split('')), n.trigger('click'))
                        : i !== c.keyCode.INSERT || t.shiftKey || t.ctrlKey
                          ? !0 === f.tabThrough &&
                            i === c.keyCode.TAB &&
                            (!0 === t.shiftKey
                              ? (null === T(a.begin).match.fn &&
                                  (a.begin = W(a.begin)),
                                (a.end = $(a.begin, !0)),
                                (a.begin = $(a.end, !0)))
                              : ((a.begin = W(a.begin, !0)),
                                (a.end = W(a.begin, !0)),
                                a.end < w().maskLength && a.end--),
                            a.begin < w().maskLength &&
                              (t.preventDefault(), ie(this, a.begin, a.end)))
                          : ((f.insertMode = !f.insertMode),
                            this.setAttribute('im-insert', f.insertMode));
                  f.onKeyDown.call(this, t, F(), ie(this).begin, f, o, r),
                    (x = -1 !== e.inArray(i, f.ignorables));
                },
                    ...
                    if (
                      (!1 !== g &&
                        ...
                        (p =
                          g.caret !== i
                            ? g.caret
                            : W(g.pos.begin ? g.pos.begin : g.pos)),
                        (w().p = p)),
                      (p = (f.numericInput && g.caret === i ? $(p) : p) + v),
                      !1 !== a &&
                        (setTimeout(function () {
                          f.onKeyValidation.call(s, u, g, f);
                        }, 0),
                        w().writeOutBuffer && !1 !== g))
                    ) {
                      var b = F();
                      z(s, b, p, t, !0 !== n);
                    }
                ...
                pasteEvent: function (n) {
                  var i,
                    ...
                    s = ie(a);
                  P && ((i = s.end), (s.end = s.begin), (s.begin = i));
                  var l = o.substr(0, s.begin),
                    c = o.substr(s.end, o.length);
                  if (
                    (l ===
                      (P ? L().reverse() : L()).slice(0, s.begin).join('') &&
                      (l = ''),
                    c === (P ? L().reverse() : L()).slice(s.end).join('') &&
                      (c = ''),
                    t.clipboardData && t.clipboardData.getData)
                  )
                    o = l + t.clipboardData.getData('Text') + c;
                  else {
                  ...
                  return (
                    te(a, !1, !1, u.toString().split('')),
                    setTimeout(function () {
                      z(a, F(), W(S()), n, m !== F().join(''));
                    }, 0),
                    n.preventDefault()
                  );
                },
                inputFallBackEvent: function (t) {
                  ...
                  if (F().join('') !== i) {
                    ...
                    if (
                      ...
                      if (l !== p) {
                        var k,
                          g = (v = l.length >= p.length) ? l.length : p.length;
                      ...
                      if (
                        (u !== h &&
                          (u.length > h.length
                            ? (d += u.slice(0, 1))
                            : u.length < h.length &&
                              ((m.end += h.length - u.length),
                              v ||
                                '' === f.radixPoint ||
                                '' !== u ||
                                l.charAt(m.begin + o - 1) !== f.radixPoint ||
                                (m.begin--, (d = f.radixPoint)))),
                        z(n, F(), {begin: m.begin + o, end: m.end + o}),
                        d.length > 0)
                      )
                  ...
                  if (t.cancelable) {
                    ...
                    switch (t.inputType) {
                      ...
                      case 'deleteContentBackward':
                        return (
                          ((i = new e.Event('keydown')).keyCode =
                            c.keyCode.BACKSPACE),
                          ee.keydownEvent.call(n, i),
                          t.preventDefault()
                        );
                ...
                clickEvent: function (t, a) {
                  ...
                  setTimeout(function () {
                    if (n.activeElement === r) {
                      var t = ie(r);
                      if (
                        (a && (P ? (t.end = t.begin) : (t.begin = t.end)),
                        t.begin === t.end)
                      )
                        switch (f.positionCaretOnClick) {
                          ...
                          default:
                            var s = t.begin,
                              ...
                              c = W(l);
                            if (s < c)
                              ie(r, q(s, !0) || q(s - 1, !0) ? s : W(s));
                            else {
                              var u = w().validPositions[l],
                                p = G(c, u ? u.match.locator : i, u),
                                h = X(c, p.match);
                              if (
                                ('' !== h &&
                                  F()[c] !== h &&
                                ...
                                (!q(c, f.keepStatic) && p.match.def === h)
                              ) {
                                var m = W(c);
                                (s >= m || s === c) && (c = m);
                              }
                ...
                cutEvent: function (i) {
                  ...
                  var a = ie(this),
                    ...
                    s = P
                      ? F().slice(a.end, a.begin)
                      : F().slice(a.begin, a.end);
                  o.setData('text', P ? s.reverse().join('') : s.join('')),
                    n.execCommand && n.execCommand('copy'),
                    (i.metaKey || i.ctrlKey) && (a.begin = 0),
                    se(this, c.keyCode.DELETE, a),
                    a.end - a.begin == this.value.length && O(!1),
                    z(this, F(), w().p, i, m !== F().join(''));
                },
                  ...
                  if (this.inputmask) {
                    ...
                    ('' === a && k === i) ||
                      ...
                      !1 === oe(r) &&
                        ...
                        f.clearIncomplete &&
                          (O(),
                          (r = f.clearMaskOnLostFocus ? [] : L().slice()))),
                      z(this, r, i, t)),
                      m !== F().join('') &&
                        ((m = r.join('')), n.trigger('change'));
                  }
                },
                mouseenterEvent: function (e) {
                  (_ = !0),
                    n.activeElement !== this &&
                      f.showMaskOnHover &&
                      Z(this, (P ? F().slice().reverse() : F()).join(''));
                },
                submitEvent: function (e) {
                  m !== F().join('') && d.trigger('change'),
                    f.clearMaskOnLostFocus &&
                      -1 === S() &&
                      y.inputmask._valueGet &&
                      y.inputmask._valueGet() === L().join('') &&
            ...
            function te(t, n, a, r, o) {
              ...
              if ((O(), a || !0 === f.autoUnmask)) p = W(p);
                ...
                var m = L().slice(0, W(-1)).join(''),
                  d = l.join('').match(new RegExp('^' + c.escapeRegex(m), 'g'));
                d &&
                  d.length > 0 &&
                  (l.splice(0, d.length * m.length), (p = W(p)));
              }
              -1 === p ? ((w().p = W(p)), (p = 0)) : (w().p = p),
                (s.caretPos = {begin: p}),
                e.each(l, function (n, r) {
                  if (r !== i)
                    if (
                      w().validPositions[n] === i &&
                      l[n] === X(n) &&
                      q(n, !0) &&
                      !1 === H(n, l[n], !0, i, i, !0)
                    )
                        ...
                        return (
                          -1 !==
                            A(!0, 0, !1)
                              ...
                              .indexOf(t) &&
                          !q(e) &&
                          (T(e).match.nativeDef === t.charAt(0) ||
                            (null === T(e).match.fn &&
                              T(e).match.nativeDef === "'" + t.charAt(0)) ||
                            (' ' === T(e).match.nativeDef &&
                              (T(e + 1).match.nativeDef === t.charAt(0) ||
                                (null === T(e + 1).match.fn &&
                                  T(e + 1).match.nativeDef ===
                                    "'" + t.charAt(0)))))
                        );
                      })(p, u)
                        ? (h = ee.keypressEvent.call(
                            t,
                            o,
                            !0,
                            !1,
                            a,
                            s.caretPos.begin
                          )) && ((p = s.caretPos.begin + 1), (u = ''))
                        : (h = ee.keypressEvent.call(t, o, !0, !1, a, c + 1)),
                        h &&
                          (z(i, F(), h.forwardPosition, o, !1),
                          (s.caretPos = {
                ...
                n &&
                  z(
                    t,
                    F(),
                    h ? h.forwardPosition : i,
                    o || new e.Event('checkval'),
                    o && 'input' === o.type
                  );
            }
            function ne(t) {
              if (t) {
                ...
                t.inputmask &&
                  ...
                  ee.setValueEvent.call(t);
              }
              var n = [],
                a = w().validPositions;
              for (var r in a)
                a[r].match && null != a[r].match.fn && n.push(a[r].input);
              var o = 0 === n.length ? '' : (P ? n.reverse() : n).join('');
            ...
            function ie(a, r, o, s) {
              function l(e) {
                return (
                  !P ||
                    ...
                    !y ||
                    (e = y.inputmask._valueGet().length - e),
                  e
                );
              }
              var c;
              ...
              if (
                (e.isArray(r) && ((o = P ? r[0] : r[1]), (r = P ? r[1] : r[0])),
                r.begin !== i &&
                  ((o = P ? r.begin : r.end), (r = P ? r.end : r.begin)),
                'number' == typeof r)
              ) {
                (r = s ? r : l(r)),
                  (o = 'number' == typeof (o = s ? o : l(o)) ? o : r);
                var u =
                  parseInt(
                ...
                if (
                  ...
                  if ('selectionStart' in a)
                    ...
                    a.createTextRange &&
                      ((c = a.createTextRange()).collapse(!0),
                      c.moveEnd('character', o),
            ...
            function re(e) {
              e.length = 0;
              for (var t, n = A(!0, 0, !0, i, !0); (t = n.shift()) !== i; )
                e.push(t);
              return e;
            }
            function oe(t) {
              if (e.isFunction(f.isComplete)) return f.isComplete(t, f);
              if ('*' === f.repeat) return i;
              var n = !1,
                a = ae(!0),
                r = $(a.l);
              if (
            ...
            function se(e, t, n, a, r) {
              ...
              if (
                (t === c.keyCode.BACKSPACE && n.end - n.begin < 1
                  ? ((n.begin = $(n.begin)),
                    w().validPositions[n.begin] !== i &&
                      w().validPositions[n.begin].input === f.groupSeparator &&
                      n.begin--)
                  : t === c.keyCode.DELETE &&
                    n.begin === n.end &&
                    ((n.end =
                      q(n.end, !0) &&
                      w().validPositions[n.end] &&
                      w().validPositions[n.end].input !== f.radixPoint
                        ? n.end + 1
                        : W(n.end) + 1),
                    w().validPositions[n.begin] !== i &&
                      w().validPositions[n.begin].input === f.groupSeparator &&
                      n.end++),
                Q(n),
                (!0 !== a && !1 !== f.keepStatic) || null !== f.regex)
              ) {
                var s = V(!0);
                if (s) {
                  var l =
                    s.caret !== i
                      ? s.caret
                      : s.pos
                        ? W(s.pos.begin ? s.pos.begin : s.pos)
                        : S(-1, !0);
                  (t !== c.keyCode.DELETE || n.begin > l) && n.begin;
                }
              }
              var u = S(n.begin, !0);
              if (u < n.begin || -1 === n.begin) w().p = W(u);
              else if (!0 !== a && ((w().p = n.begin), !0 !== r))
                for (; w().p < u && w().validPositions[w().p] === i; ) w().p++;
            }
            function le(i) {
              var a = (i.ownerDocument.defaultView || t).getComputedStyle(
                i,
                null
              );
            ...
            function ce(e, t, a) {
              ...
              function p(e) {
                if (
                  (e === i && (e = ''), c || (null !== r.fn && o.input !== i))
                )
                  if (c && ((null !== r.fn && o.input !== i) || '' === r.def)) {
                    c = !1;
                    var t = l.length;
                  ...
                  c && p(),
                    n.activeElement === e &&
                      (l.splice(
                        t.begin,
                        0,
                        t.begin === t.end || t.end > w().maskLength
            ...
            if (
              ...
              switch (a.action) {
                ...
                case 'unmaskedvalue':
                  return (
                    (y !== i && a.value === i) ||
                      ...
                      (J = (
                        (e.isFunction(f.onBeforeMask) &&
                          f.onBeforeMask.call(b, J, f)) ||
                        J
                      ).split('')),
                      te.call(this, i, !1, !1, J),
                      e.isFunction(f.onBeforeWrite) &&
                        f.onBeforeWrite.call(b, i, F(), 0, f)),
                    ne(y)
                  );
                case 'mask':
                  !(function (t) {
                    ...
                    if (
                      ...
                      ((d = e((y = t))),
                      (g = y.placeholder),
                      -1 === (v = y !== i ? y.maxLength : i) && (v = i),
                      !0 === f.colorMask && le(y),
                      o &&
                        ('inputmode' in y &&
                          ((y.inputmode = f.inputmode),
                          y.setAttribute('inputmode', f.inputmode)),
                        !0 === f.disablePredictiveText &&
                          ('autocorrect' in y
                            ...
                            : (!0 !== f.colorMask && le(y),
                              (y.type = 'password')))),
                      !0 === a &&
                        (y.setAttribute('im-insert', f.insertMode),
                        Y.on(y, 'submit', ee.submitEvent),
                        Y.on(y, 'reset', ee.resetEvent),
                        Y.on(y, 'blur', ee.blurEvent),
                        Y.on(y, 'focus', ee.focusEvent),
                        !0 !== f.colorMask &&
                          (Y.on(y, 'click', ee.clickEvent),
                          Y.on(y, 'mouseleave', ee.mouseleaveEvent),
                          Y.on(y, 'mouseenter', ee.mouseenterEvent)),
                        Y.on(y, 'paste', ee.pasteEvent),
                        Y.on(y, 'cut', ee.cutEvent),
                        Y.on(y, 'complete', f.oncomplete),
                        Y.on(y, 'incomplete', f.onincomplete),
                        Y.on(y, 'cleared', f.oncleared),
                        o || !0 === f.inputEventOnly
                          ? y.removeAttribute('maxLength')
                          : (Y.on(y, 'keydown', ee.keydownEvent),
                            Y.on(y, 'keypress', ee.keypressEvent)),
                        Y.on(y, 'input', ee.inputFallBackEvent),
                        Y.on(y, 'beforeinput', ee.beforeInputEvent)),
                      Y.on(y, 'setvalue', ee.setValueEvent),
                      (m = L().join('')),
                      ...
                      var s = F().slice();
                      (m = s.join('')),
                        !1 === oe(s) && f.clearIncomplete && O(),
                        f.clearMaskOnLostFocus &&
                          n.activeElement !== y &&
                          (-1 === S() ? (s = []) : re(s)),
                        (!1 === f.clearMaskOnLostFocus ||
                          (f.showMaskOnFocus && n.activeElement === y) ||
                          '' !== y.inputmask._valueGet(!0)) &&
                          z(y, s),
                        n.activeElement === y && ie(y, W(S()));
                    }
                  })(y);
                  break;
                case 'format':
                  return (
                    (J = (
                      (e.isFunction(f.onBeforeMask) &&
                        f.onBeforeMask.call(b, a.value, f)) ||
                      a.value
                    ).split('')),
                    te.call(this, i, !0, !1, J),
                    a.metadata
                      ? {
                          value: P
                            ? F().slice().reverse().join('')
                            : F().join(''),
                          metadata: h.call(this, {action: 'getmetadata'}, u, f),
                        }
                      : P
                        ? F().slice().reverse().join('')
                        : F().join('')
                ...
                case 'isValid':
                  a.value
                    ? ((J = a.value.split('')), te.call(this, i, !0, !0, J))
                    : (a.value = F().join(''));
                  for (
                    var ue = F(), fe = ae(), pe = ue.length - 1;
                    pe > fe && !q(pe);
                    pe--
                  );
                  return (
                    ue.splice(fe, pe + 1 - fe),
                    oe(ue) && a.value === F().join('')
                  );
                case 'getemptymask':
                  return L().join('');
                case 'remove':
                  if (y && y.inputmask)
                    e.data(y, '_inputmask_opts', null),
                      (d = e(y)),
                      y.inputmask._valueSet(
                        f.autoUnmask ? ne(y) : y.inputmask._valueGet(!0)
                      ),
                      Y.off(y),
                      y.inputmask.colorMask &&
                        ((k = y.inputmask.colorMask).removeChild(y),
                        k.parentNode.insertBefore(y, k),
          ...
          return (
            (c.prototype = {
              ...
              definitions: {
                ...
                '?': {validator: '.', cardinality: 1, definitionSymbol: '*'},
              ...
              mask: function (a) {
                ...
                return (
                  'string' == typeof a &&
                    (a = n.getElementById(a) || n.querySelectorAll(a)),
                  (a = a.nodeName ? [a] : a),
                  e.each(a, function (n, a) {
                    ...
                    if (
                      ...
                      s !== i &&
                        (a.inputmask !== i &&
                          ((a.inputmask.opts.autoUnmask =
                            a.inputmask.opts.autoUnmask),
                          a.inputmask.remove()),
                        (a.inputmask = new c(i, i, !0)),
                        (a.inputmask.opts = o),
                        (a.inputmask.noMasksCache = r.noMasksCache),
                        (a.inputmask.userOptions = e.extend(
                          !0,
                          {},
                          r.userOptions
                        )),
                        (a.inputmask.isRTL = o.isRTL || o.numericInput),
                        (a.inputmask.el = a),
                        (a.inputmask.maskset = s),
                        e.data(a, '_inputmask_opts', o),
              ...
              unmaskedvalue: function (e) {
                return (
                  ...
                  h.call(this, {action: 'unmaskedvalue', value: e})
                );
              },
              remove: function () {
              ...
              getemptymask: function () {
                return (
                  (this.maskset =
                    this.maskset || f(this.opts, this.noMasksCache)),
                  h.call(this, {action: 'getemptymask'})
                );
              },
              ...
              getmetadata: function () {
                return (
                  (this.maskset =
                    this.maskset || f(this.opts, this.noMasksCache)),
                  h.call(this, {action: 'getmetadata'})
                );
              },
              isValid: function (e) {
                return (
                  (this.maskset =
                    this.maskset || f(this.opts, this.noMasksCache)),
                  h.call(this, {action: 'isValid', value: e})
                );
              },
              format: function (e, t) {
                return (
                  (this.maskset =
                    this.maskset || f(this.opts, this.noMasksCache)),
                  h.call(this, {action: 'format', value: e, metadata: t})
                );
              },
              setValue: function (t) {
              ...
              analyseMask: function (t, n, a) {
                ...
                function b(t, r, o) {
                  ...
                  if (n)
                        ...
                        e.each(r.split(''), function (e, n) {
                          (s = t.matches[o - 1]),
                            t.matches.splice(o++, 0, {
                              ...
                              placeholder:
                                a.staticDefinitionSymbol !== i ? n : i,
                              nativeDef: (m ? "'" : '') + n,
                            });
                        })),
                      (m = !1);
                    ...
                    var l =
                      (a.definitions ? a.definitions[r] : i) ||
                      c.prototype.definitions[r];
                    if (l && !m) {
                      for (
                        var u = l.prevalidator, f = u ? u.length : 0, p = 1;
                        p < l.cardinality;
                        p++
                      ) {
                        var h = f >= p ? u[p - 1] : [],
                        ...
                        t.matches.splice(o++, 0, {
                          ...
                          newBlockMarker:
                            s === i || s.def !== (l.definitionSymbol || r),
                          casing: l.casing,
                ...
                for (
                  n && ((a.optionalmarker[0] = i), (a.optionalmarker[1] = i));
                  (r = n ? h.exec(t) : p.exec(t));
                          ...
                          w =
                            1 === _.length
                              ...
                              : isNaN(_[1])
                                ...
                                : parseInt(_[1]);
                        ('*' !== A && '+' !== A) || (A = '*' === w ? 0 : 1),
                          (C.quantifier = {min: A, max: w, jit: x[1]});
                        var O =
                          v.length > 0 ? v[v.length - 1].matches : d.matches;
                      ...
                      r &&
                        ...
                        e.each(r.matches, function (e, o) {
                          ...
                          (s === i ||
                            ...
                            ((o.isGroup = !1),
                            n ||
                              (b(o, a.groupmarker[0], 0),
                              !0 !== o.openGroup && b(o, a.groupmarker[1]))),
                            t(o);
                        });
                    })(d),
                    k.push(d)),
                        ...
                        if (t.matches.hasOwnProperty(n)) {
                          ...
                          if (
                            ...
                            t.matches.splice(n, 1),
                              t.matches.splice(r + 1, 0, o);
                          }
                          t.matches[n].matches !== i
                            ? (t.matches[n] = e(t.matches[n]))
                            : (t.matches[n] =
                                ((s = t.matches[n]) === a.optionalmarker[0]
                                  ? (s = a.optionalmarker[1])
                                  : s === a.optionalmarker[1]
                                    ? (s = a.optionalmarker[0])
                                    : s === a.groupmarker[0]
                                      ? (s = a.groupmarker[1])
                                      : s === a.groupmarker[1] &&
                                        (s = a.groupmarker[0]),
            ...
            (c.remove = function (t) {
              'string' == typeof t &&
                (t = n.getElementById(t) || n.querySelectorAll(t)),
                (t = t.nodeName ? [t] : t),
