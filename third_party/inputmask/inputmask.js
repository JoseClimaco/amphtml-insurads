          ...
          if (
            ...
            $.each(element.split(''), function (ndx, lmnt) {
              ...
              mtoken.matches.splice(position++, 0, {
                ...
                placeholder:
                  opts.staticDefinitionSymbol !== undefined ? lmnt : undefined,
      ...
      do {
        if (baseOnInput === true && getMaskSet().validPositions[pos]) {
          ...
          if (
            ...
            maskTemplate.push(
              includeMode === false ? test.nativeDef : getPlaceholder(pos, test)
            );
          }
        }
        ...
        function handleMatch(match, loopNdx, quantifierRecurse) {
          ...
          function isSubsetOf(source, target) {
            ...
            if (
              ...
              return (
                expand(target.match.def.replace(/[\[\]]/g, '')).indexOf(
          ...
          function staticCanMatchDefinition(source, target) {
            var sloc = source.locator.slice(source.alternation).join(''),
              ...
              canMatch = sloc == tloc;
            canMatch =
              canMatch && source.match.fn === null && target.match.fn !== null
            ...
            if (
              ...
              (targetMatch.alternation === altMatch.alternation &&
                targetMatch.locator[targetMatch.alternation]
                  .toString()
                  .indexOf(altMatch.locator[altMatch.alternation]) === -1)
            ) {
            ...
            if (match.isGroup && quantifierRecurse !== match) {
              ...
              if (altIndex === -1 || typeof altIndex === 'string') {
                ...
                if (getMaskSet().excludes[pos]) {
                  ...
                  for (
                    var i = 0, el = getMaskSet().excludes[pos].length;
                    i < el;
                    i++
                  ) {
                    altIndexArr.splice(
                      altIndexArr.indexOf(
                        getMaskSet().excludes[pos][i].toString()
                      ),
                      1
                    );
                  }
                  ...
                  for (var ndx1 = 0; ndx1 < maltMatches.length; ndx1++) {
                    ...
                    for (
                      ...
                      if (
                        ...
                        if (
                          altMatch.match.nativeDef === altMatch2.match.nativeDef
                        ) {
                          dropMatch = true;
              ...
              if (tst.def !== '') {
                if (locator.length === 0) locator = tst.locator.slice();
                  ...
                  for (var i = 0; i < locator.length; i++) {
                    if (
                      tst.locator[i] &&
                      locator[i].toString().indexOf(tst.locator[i]) === -1
                    ) {
      ...
      if (alternation !== undefined) {
        ...
        while (
          ...
          while (validInputs.length > 0) {
            ...
            if (
              !(isValidRslt = isValid(
                getLastValidPosition(undefined, true) + 1,
                input,
                false,
                fromSetValid,
                true
          ...
          if (isValidRslt && c !== undefined) {
            ...
            for (i = decisionPos; i < getLastValidPosition() + 1; i++) {
              validPos = getMaskSet().validPositions[i];
              if (
                (validPos === undefined || validPos.match.fn == null) &&
                i < pos + posOffset
              ) {
                posOffset++;
              }
          ...
          if (!isValidRslt) {
            ...
            if (getMaskSet().excludes[decisionPos]) {
              ...
              if (
                getMaskSet().excludes[decisionPos].indexOf(decisionTaker) !== -1
              ) {
      ...
      function _isValid(position, c, strict) {
        ...
        $.each(getTests(position), function (ndx, tst) {
          ...
          if (rslt !== false) {
            ...
            elem =
              elem === opts.skipOptionalPartCharacter && test.fn === null
              ...
              if (
                (opts.insertMode ||
                  getMaskSet().validPositions[seekNext(maskPos)] ===
                    undefined) &&
                (!isMask(maskPos, true) || getMaskSet().jitOffset[maskPos])
              ) {
                if (
                  ...
                  result = isValid(
                    maskPos + getMaskSet().jitOffset[maskPos],
                    c,
                    strict
                  );
        ...
        if (
          ...
          if (vp) {
            ...
            bestMatch = $.extend({}, bestMatch, {
              input:
                getPlaceholder(ps, bestMatch.match, true) ||
                bestMatch.match.def,
            });
          ...
          if (
            ...
            while (getTest(posMatch).match.def !== '') {
              if (
                ...
                positionsClone[posMatch].match.nativeDef === t.match.nativeDef
              ) {
              ...
              if (
                ...
                (t.match.fn !== null || posMatch > getMaskSet().maskLength)
              ) {
                break;
              }
              posMatch++;
        ...
        var ev = function (e) {
          ...
          if (that.inputmask === undefined && this.nodeName !== 'FORM') {
            ...
            (that.disabled ||
              (that.readOnly &&
                !(
                  (e.type === 'keydown' && e.ctrlKey && e.keyCode === 67) ||
      ...
      $.each(inputValue, function (ndx, charCode) {
        if (charCode !== undefined) {
          if (
            ...
            isMask(ndx, true) &&
            isValid(ndx, inputValue[ndx], true, undefined, undefined, true) ===
              false
          ) {
            getMaskSet().p++;
          } else {
      ...
      if (
        ...
        for (var i = 0; i <= aml; i++) {
          ...
          if (
            ...
            (test.fn === null && buffer[i] !== getPlaceholder(i, test))
          ) {
            complete = false;
            break;
          }
    ...
    function renderColorMask(input, caretPos, clear) {
      ...
      function setEntry(entry) {
        ...
        if (!isStatic && (test.fn === null || testPos.input === undefined)) {
          ...
          isStatic &&
          ((test.fn !== null && testPos.input !== undefined) || test.def === '')
        ) {
          isStatic = false;
      ...
      switch (actionObj.action) {
        ...
        case 'remove':
          if (el && el.inputmask) {
            ...
            $el = $(el);
            el.inputmask._valueSet(
              opts.autoUnmask ? unmaskedvalue(el) : el.inputmask._valueGet(true)
            );
            EventRuler.off(el);
