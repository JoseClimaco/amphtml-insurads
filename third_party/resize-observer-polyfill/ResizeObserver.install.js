  ...
  (function (global, factory) {
      ...
      ResizeObserverSPI.prototype.checkRootChanges_ = function () {
        ...
        this.observations_.forEach(function (observation) {
          var target = observation.target,
            oldRootNode = observation.rootNode;
    ...
    var ResizeObserverController = /** @class */ (function () {
      ...
      ResizeObserverController.prototype.connect_ = function () {
        ...
        if (rootNode.host) {
          this.hostObserver_ = new ResizeObserverSPI(
            this.refresh,
            this.globalController_,
            this
          );
    ...
    var GlobalResizeObserverController = /** @class */ (function () {
       ...
       * @returns {void}
       */
      GlobalResizeObserverController.prototype.addObserver = function (
        rootNode,
        observer
      ) {
       ...
       * @returns {void}
       */
      GlobalResizeObserverController.prototype.removeObserver = function (
        rootNode,
        observer
      ) {
        var rootNodeController = this.rootNodeControllers_.get(rootNode);
