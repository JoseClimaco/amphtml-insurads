/* Generated from closure library version 20210202.0.0 */ const window = {
...
*/
  ...
  function I(a) {
    return 0 < a
      ? 0x7fffffffffffffff <= a
        ? J
        : new t(a, a / 4294967296)
      : 0 > a
        ? -9223372036854775808 >= a
          ? E
          : z(new t(-a, -a / 4294967296))
        : H;
  }
  function w(a, b) {
    return new t(a, b);
  ...
  function P(a, b, e) {
    ...
    if ('string' === typeof b) {
      ...
      if (
        ((d = typeof b),
        (d = 'object' != d ? d : b ? (Array.isArray(b) ? 'array' : d) : 'null'),
        'array' == d || ('object' == d && 'number' == typeof b.length))
      ) {
        for (d = 0; d < e; d++) {
          f = b[d];
  ...
  function Q(a) {
    for (var b = a.m, e = a.B, c = 0; 16 > c; c++) {
      var d = 8 * c;
      e[c] = new t(
        (b[d + 4] << 24) | (b[d + 5] << 16) | (b[d + 6] << 8) | b[d + 7],
        (b[d] << 24) | (b[d + 1] << 16) | (b[d + 2] << 8) | b[d + 3]
      );
    }
    for (c = 16; 80 > c; c++) {
      d = e[c - 15];
      ...
      e[c] = a.v(
        ...
        e[c - 7],
        new t(
          (b >>> 1) ^ (d << 31) ^ (b >>> 8) ^ (d << 24) ^ (b >>> 7) ^ (d << 25),
          (d >>> 1) ^ (b << 31) ^ (d >>> 8) ^ (b << 24) ^ (d >>> 7)
        ),
        new t(
          (g >>> 19) ^
            (f << 13) ^
    ...
    for (c = 0; 80 > c; c++) {
      var p = b.h,
        m = b.g;
      p = new t(
        (p >>> 28) ^ (m << 4) ^ (m >>> 2) ^ (p << 30) ^ (m >>> 7) ^ (p << 25),
        (m >>> 28) ^ (p << 4) ^ (p >>> 2) ^ (m << 30) ^ (p >>> 7) ^ (m << 25)
      ).add(
        new t(
          (b.h & d.h) | (d.h & g.h) | (b.h & g.h),
          (b.g & d.g) | (d.g & g.g) | (b.g & g.g)
        )
      );
      m = h.h;
      var y = h.g,
  ...
  K.prototype.v = function (a, b, e) {
    for (
      var c = (a.h ^ 2147483648) + (b.h ^ 2147483648),
        d = a.g + b.g,
