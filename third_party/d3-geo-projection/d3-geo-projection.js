!(function () {
  ...
  function s(t) {
    function n(t, n) {
      var a = Math.cos(t),
        ...
        o = Math.sin(n),
        i = e * a,
        h = -((1 - i ? Math.log(0.5 * (1 + i)) / (1 - i) : -0.5) + r / (1 + i));
  ...
  function v(t) {
    ...
    return (
      (n.invert = function (t, n) {
        ...
        return e * u > -Math.atan2(Math.cos(h), o) - 0.001 ? [2 * h, u] : null;
      }),
      n
    );
  }
    ...
    return (
      (e.parallel = function (e) {
        return arguments.length
          ? ((a = Math.tan((n = (t = (e * pa) / 180) > 0 ? 1 : -1) * t)), r(t))
          : 180 * (t / pa);
      }),
      (e.stream = function (r) {
        var i = e.rotate(),
  ...
  function m(t, n) {
    ...
    return pa / 4 > a
      ...
      : [
          ...
          i(n) * (2 * Math.SQRT2 * (a - pa / 4) - Math.log(Math.tan(a / 2))),
        ];
  }
  function y(t) {
    function n(t, n) {
        ...
        if (r > wa) {
          var e = Math.atan2(n, t),
            ...
            u =
              1 /
              Math.tan(
                i * Math.acos((h - pa) / Math.sqrt(pa * (pa - 2 * h) + r * r))
              );
          ...
          (M.sphere = function () {
            ...
            for (
              ...
              s.point(
                ...
                -90 > u
                  ? (s.point(-90, -180 - u - e), s.point(-90, -180 - u + e))
  ...
  function _(t) {
    function n(n, a) {
      for (
        ...
        var s = t[M];
        if (((o[M] = B(a - s[1], s[3], s[2], e, r, n - s[0])), !o[M][0]))
          return s.point;
        o[M][1] = j(o[M][1] - s.v[1]);
      }
    ...
    var o = F(t[0].v[0], t[2].v[0], t[1].v[0]),
      ...
      h = pa - o;
    (t[2].point[1] = 0), (t[0].point[0] = -(t[1].point[0] = 0.5 * t[0].v[0]));
    var u = [
    ...
    return (
      (n.invert = a
        ? function (t, n) {
            ...
            return [
              t,
              2 * Math.atan2(Math.sqrt(r * r + a * a - n * n) - r, a - n),
            ];
          }
        : function (t, n) {
  ...
  function U(t, n) {
    ...
    return (a = Math.sqrt(2 + pa)), [(t * (1 + Math.cos(n))) / a, (2 * n) / a];
  }
  function V(t, n) {
    var a = Math.sin((t /= 2)),
      r = Math.cos(t),
    ...
    return (
      ...
      (o.stream = function (n) {
        ...
        return (
          ...
          (h.sphere = function () {
            s.polygonStart(), s.lineStart();
            for (var n = 0, e = (2 * pa) / t, o = 0; t > n; ++n, o -= e)
              s.point(
      ...
      (u.invert = function (u, s) {
        ...
        do {
          ...
          if (
            ...
            (msinα = m * sinα),
            (dαdφ =
              ((v / pa) * (1 / M(1 - xB2 / y)) * (dxBdφ * m - b * dmdφ)) / y),
            (fx = msinα - u),
          ...
          (a.invert = n
            ? function (n, a) {
                var e = (n + a) * Math.SQRT1_2,
                  o = (a - n) * Math.SQRT1_2,
                  i = Math.abs(e) < 0.5 * r && Math.abs(o) < 0.5 * r;
                if (!i) {
    ...
    return (
      ...
      (n.invert = function (t, n) {
        var r = Math.sqrt(t * t + n * n),
          ...
          v =
            (r > wa ? -1 : 1) *
            Math.atan2(t * o, r * Math.cos(f) * i + n * Math.sin(f) * o);
        return e.invert(v, f);
      }),
      n
    );
    ...
    return (
      (n.invert = function (n, r) {
        ...
        if (s > i) {
          ...
          var f = d3.geo.collignon.raw.invert(n, (0.25 * (s - i) * e) / u + h);
          return (
            (f[0] -= (pa * (t - 1)) / t - c * M), 0 > r && (f[1] = -f[1]), f
          );
        }
        return a.invert(n, r);
      }),
      ...
      return {
        ...
        coordinates: [
          d3
            ...
            .concat(
              d3.range(180, -180 - t / 2, -t).map(function (t, n) {
                return [t, 1 & n ? -90 + 1e-6 : -Ca];
              })
            ),
        ],
      ...
      if (f && 2 > f) {
        ...
        do {
          var d = Math.sin(l),
            ...
            w = 1 + c - 2 * r * b;
          l -= v = (l - s * o - r * d + w * p - 0.5 * f * a) / (2 * r * d * p);
  ...
  function An(t) {
    ...
    return (
      (n.invert = function (n, r) {
        ...
        do {
          for (
            var u, M = a, s = t[M], c = s[0], f = s[1], v = 0, l = 0;
            --M >= 0;
  ...
  function On(t, n) {
    ...
    return [
      ...
      n *
        (1.007226 +
          a * (0.015085 + r * (-0.044475 + 0.028874 * a - 0.005916 * r))),
    ];
  }
  function Hn(t, n) {
  ...
  function Zn() {
    ...
    return (
      ...
      (a.points = function (a) {
        ...
        return (
          i[0] > 0 && (M = pa - M), r.call(i, [-o[0], -o[1], -M * ya]), n(2 * u)
        );
      }),
      a
    );
    ...
    return (
      ...
      (a.points = function (a) {
        ...
        var e = d3.geo.interpolate(a[0], a[1]),
          ...
          M = -h(Math.sin(i[1] * ma) / Math.sin(u));
        return (
          i[0] > 0 && (M = pa - M), r.call(i, [-o[0], -o[1], -M * ya]), n(u)
        );
      }),
      a
    );
  ...
  var Ma = {
    ...
    fa = {
      ...
      result: function () {
        var t = sa.length
          ? sa.length < 2
            ? {type: 'Point', coordinates: sa[0]}
            : {type: 'MultiPoint', coordinates: sa}
          : null;
        return (sa = []), t;
      },
    },
    va = {
      ...
      result: function () {
        var t = ca.length
          ? ca.length < 2
            ? {type: 'LineString', coordinates: ca[0]}
            : {type: 'MultiLineString', coordinates: ca}
          : null;
        return (ca = []), t;
      },
    },
  ...
  (d3.geo.interrupt = function (t) {
    function n(n, a) {
      for (
        var r = 0 > a ? -1 : 1, e = h[+(0 > a)], o = 0, i = e.length - 1;
        i > o && n > e[o][2][0];
        ++o
      );
      var u = t(n - e[o][1][0], a);
      return (
        (u[0] += t(e[o][1][0], r * a > r * e[o][0][1] ? e[o][0][1] : a)[0]), u
      );
    }
    function a() {
      i = h.map(function (n) {
  ...
  (m.invert = function (t, n) {
    ...
    do {
      var u = Math.cos(o / 2),
        M = Math.tan(o / 2);
      o -= a = (e * (o - pa / 4) - Math.log(M) - r) / (e - (0.5 * u * u) / M);
    ...
    (V.invert = function (t, n) {
      ...
      do {
        var i = r / 2,
          ...
          T =
            (Math.SQRT2 * M * c + v) /
            (2 * (c + Math.SQRT2 * M * v) * (c + Math.SQRT2 * M * v) * v),
          x = -0.5 * l * d * d * d,
          E = x * R,
          k = x * T,
  ...
  ((d3.geo.ginzburg6 = function () {
    ...
    (an.invert = function (t, n) {
      ...
      do {
        var h = (h = r * r) * h;
        r -= a = (r * (0.87 - 952426e-9 * h) - t) / (0.87 - 0.00476213 * h);
      } while (Math.abs(a) > da && --o > 0);
      return [r, e];
    }),
  ...
  ((d3.geo.ginzburg9 = function () {
    ...
    (fn.invert = function (t, n) {
      ...
      return [
        ...
        2 *
          Math.atan(
            Math.exp((0.5 / o) * Math.log(a * h[0] * h[0] + a * h[1] * h[1]))
          ) -
          wa,
      ];
    }),
  ...
  (qn.invert = function (t, n) {
    ...
    (mn.invert = function (t, n) {
      var a =
        Math.abs((a = n * (0 > n ? 0.5179951515653813 : 0.5686373742600607))) >
        1 - da
          ? a > 0
            ? wa
            : -wa
  ...
  (Tn.invert = function (t, n) {
    ...
    (zn.invert = function (t, n) {
      ...
      do {
        var o = a * a,
          ...
          u = a * r,
          M =
            a * (0.975534 + h * (-0.119161 + o * -0.0143059 + h * -0.0547009)) -
            t,
          s =
            r *
              (1.00384 +
            ...
            n,
          c = 0.975534 - h * (0.119161 + 0.0143059 * 3 * o + 0.0547009 * h),
    ...
    (Bn.invert = function (t, n) {
      var a = t * t,
        ...
        o = t
          ? Math.SQRT1_2 *
            Math.sqrt((e - Math.sqrt(a * a + 2 * a * (r - 1) + e * e)) / a + 1)
          : 1 / Math.sqrt(e);
  ...
  ((d3.geo.modifiedStereographic = Gn).raw = An),
    ...
    (Dn.invert = function (t, n) {
      var a = (n * Math.sqrt(2 + Math.SQRT2)) / (2 * Math.sqrt(3)),
        r = 2 * h(a);
      return [
        (3 * Math.SQRT2 * t) / (1 + (2 * Math.cos(r)) / Math.cos(r / 2)),
    ...
    (On.invert = function (t, n) {
      ...
      do {
        ...
        r -= a =
          (r *
            (1.007226 +
              o * (0.015085 + i * (-0.044475 + 0.028874 * o - 0.005916 * i))) -
            n) /
          (1.007226 +
            o *
              (0.045255 + i * (-0.311325 + 0.259866 * o - 0.005916 * 11 * i)));
      } while (Math.abs(a) > da && --e > 0);
      return [
        t /
          (0.8707 +
  ...
  Za.forEach(function (t) {
    ...
    (na.invert = function (t, n) {
      ...
      var a = (t /= pa) * t,
        ...
        s = -2 * h + 1 + 2 * r + o,
        c =
          r / s + ((2 * M * M * M) / (s * s * s) - (9 * h * M) / (s * s)) / 27,
        f = (h - (M * M) / (3 * s)) / s,
        v = 2 * Math.sqrt(-f / 3),
        l = u((3 * c) / (f * v)) / 3;
      return [
